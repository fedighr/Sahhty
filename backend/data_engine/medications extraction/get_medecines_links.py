...
GROQ_API_KEY = "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"
...
with open(os.path.join(current_folder, 'DCI_newDataset.txt'), 'r') as f:
    lines = [line.strip() for line in f if line.strip()]

results = []

with open(os.path.join(current_folder, 'unmatched_dci.txt'), 'w') as f_miss:
...
with open(os.path.join(current_folder, 'results.json'), 'w', encoding='utf-8') as f_json:
